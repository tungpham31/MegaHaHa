 ...
 */
public abstract class YouTubeActivity extends SherlockFragmentActivity
		implements OnInitializedListener, PlaylistEventListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMenuDrawer.setMenuSize(getResources().getDimensionPixelSize(
				R.dimen.menu_drawer_width));

		findViewById(R.id.hot).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				final Intent intent = new Intent(YouTubeActivity.this,
						HotActivity.class);
		...
		((YouTubePlayerSupportFragment) getSupportFragmentManager()
				.findFragmentById(R.id.youtube_fragment)).initialize(
					...
					builder.setNegativeButton(R.string.never,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
										int which) {
									mPref.edit()
											.putBoolean("allowFacebook", false)
											.commit();
								}
							});
	...
	protected void updateLikeItem(boolean itemSelected) {
		...
		if (mIsLikeItemSelected)
			mLikeItem.setIcon(getResources().getDrawable(
					R.drawable.selected_ic_action_like));
		else
			mLikeItem.setIcon(getResources().getDrawable(
	...
	public void onLoaded(String videoId) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			findViewById(R.id.content_frame).setSystemUiVisibility(
	...
	private void publishVideo() {
		...
		if (!session.getPermissions().contains("publish_actions")) {
			final NewPermissionsRequest newPermissionsRequest = new NewPermissionsRequest(
		...
		params.putString("description",
				"on Google Play Store to discover more funny videos.");
		...
		new RequestAsyncTask(new Request(session, "me/feed", params,
				HttpMethod.POST, callback)).execute();
	}
